...
## 13. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-session-query contract live-authority pointer
...
## 14. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-session-query authorization pointer
...
## 15. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-session-query R1 pointer
