...
~~~text
ARTIFACT_ID=V0_3_S3_A2_ACCEPTED_S2_TRAIN_VAL_SOURCE_002_ROW_LEVEL_READ_LIVE_OBTAIN_CONTRACT
ARTIFACT_VERSION=v0-3-s3-a2-accepted-s2-train-val-source-002-row-level-read-live-obtain-contract-v1
...
CONTRACT_PATH=docs/v0-3/s3/s3-accepted-s2-train-val-source-002-row-level-read-live-obtain-contract.md
...
row-level-read live-obtain** contract freeze after user authorization
...
This PR freezes WHAT/HOW for the dedicated **live obtain** slice: a **future**
deterministic service may obtain accepted TRAIN/VALIDATION `content_bytes`
through the already-bound live session. This is **not** `可以实施`, not a grant,
...
| # | path |
|---|------|
| 1 | `docs/v0-3/s3/s3-accepted-s2-train-val-source-002-row-level-read-live-obtain-contract.md` |
| 2 | `docs/v0-3/s3/workpapers/s3-accepted-s2-train-val-source-002-row-level-read-live-obtain-contract.md` |
| 3 | `docs/v0-3/s3/evidence/s3-accepted-s2-train-val-source-002-row-level-read-live-obtain-contract.json` |
...
parent SOURCE_002 row-level-read contract, live-session contract, or any A2
...
### 2.7 Populated-origin closed family
...
### 2.8 Completeness dataset-claim R1 (#401)
...
### 2.9 Sibling contracts (frozen, not edited)
...
obtain of TRAIN/VAL `content_bytes` only:
...
live-obtain evidence. H7 fixture hash
...
Only `S3_A2_ACCEPTED_S2_TRAIN_VAL_SOURCE_002_ROW_LEVEL_READ_LIVE_OBTAIN_CONTRACT_AUTHORIZED`
...
live-session three live keys, `NO_VERSIONED`, `NO_REVIEWED`,
...
~~~text
EVIDENCE_JSON_SHA256=1c2c332fb0f45e0d278598753c4864396276c692a32c342d6f6b84763dbf9bc5
~~~
