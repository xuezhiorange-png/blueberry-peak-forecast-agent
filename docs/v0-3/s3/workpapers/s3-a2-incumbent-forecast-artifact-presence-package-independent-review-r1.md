# V0.3-S3-A2 Incumbent forecast artifact presence-package independent-review R1

## Artifact identity

~~~text
ARTIFACT_ID=V0_3_S3_A2_INCUMBENT_FORECAST_ARTIFACT_PRESENCE_PACKAGE_INDEPENDENT_REVIEW_R1
ARTIFACT_VERSION=s3-a2-incumbent-forecast-artifact-presence-package-independent-review-r1
TASK_ID=V03_S3_A2_INCUMBENT_FORECAST_ARTIFACT_PRESENCE_PACKAGE_INDEPENDENT_REVIEW_R1
TASK_CLASS=IMPLEMENTATION
AUTHORIZATION_SCOPE=S3_A2_INCUMBENT_FORECAST_ARTIFACT_PRESENCE_PACKAGE_INDEPENDENT_REVIEW_IMPLEMENTATION_ONLY
SLICE=V0.3-S3
...
BASE_MAIN_SHA=75c79ab6d21cb4902bd0eb9075bfa2a2885b8782
BASE_MAIN_TREE_SHA=4d05403a7d4a51950610a750d17e9bd7f20140c8
PARENT_GRANT_PR=517
...
PARENT_GRANT_WORKPAPER_GIT_BLOB_SHA=54832aaa1589eb11ef6331f484c777a8c12ef58c
PARENT_GRANT_EVIDENCE_GIT_BLOB_SHA=f53083a4d79f3cfddfee296bce4ca1233324f14e
...
WORKPAPER_PATH=docs/v0-3/s3/workpapers/s3-a2-incumbent-forecast-artifact-presence-package-independent-review-r1.md
EVIDENCE_JSON_PATH=docs/v0-3/s3/evidence/s3-a2-incumbent-forecast-artifact-presence-package-independent-review-r1.json
...
Grant merge #517 is on main. User said 「可以实施」. This R1 records independent
coordinator review of the presence package bound to already-landed identities.
It calls content-for-reviewed-grains `classify()` directly, computes a hashable
review-evidence digest from existing identities (reviewed-set SHA256, content
identity from frozen producer, member-shape, presence observation recorded),
does not invent the content identity hash, does not flip `NO_VERSIONED`, may
record precondition 4 HOLD without flipping `NO_VERSIONED`, does not authorize
completeness PASS, leaves default empty obtain as None, and does not treat
in-memory catalog `00f6bc53…` as this presence package.

The §203 grant snapshot is isolated: it still records
...
Presence-package independent-review R1 ≠ versioned artifact in repository ≠ peak
tonnes ≠ rewriting frozen content-for-reviewed-grains, presence-observation,
content-producer, reviewed-set closeout, completeness PASS closeout, or
identity-set landing bytes.
`PRESENCE_PACKAGE_INDEPENDENT_REVIEW_IMPLEMENTED=true` means independent
coordinator review of the presence package is recorded from existing identities
without flipping `NO_VERSIONED`. Frozen presence-observation still reports
precondition 3 False. Frozen presence R1 still records fail-closed historical
no-reviewed-set. Completeness PASS stays unauthorized. Weather and plans remain
deferred.

## 1. Delivered

- `backend/app/s3_daily_rowset/s3_a2_incumbent_forecast_artifact_presence_package_independent_review.py`
- `backend/tests/s3_daily_rowset/test_s3_a2_incumbent_forecast_artifact_presence_package_independent_review_r1.py`

Review-evidence digest `40e03141b52188cafe9e9cb6842d14f2ebd6caa3abe1fd80142ad71162781f64`
is computed by `sha256_payload` from already-landed identities: reviewed-set
...
from frozen producer, member-shape (cutoff `2026-02-16T00:00:00+08:00`, model
`V0_2_CURRENT_INCUMBENT_MODEL_AT_HISTORICAL_CUTOFF`, P50/P80/P90), and that
presence observation recorded the three-grain artifact. If content-for-reviewed-grains
...
~~~text
DETERMINISTIC_INCUMBENT_FORECAST_ARTIFACT_PRESENCE_PACKAGE_INDEPENDENT_REVIEW_IMPLEMENTED=false → true
...
NO_VERSIONED_FLIP_PRECONDITION_3_HOLDS=true (inherited from #515; does not flip NO_VERSIONED)
NO_VERSIONED_FLIP_PRECONDITION_4_HOLDS=true (success path only; does not flip NO_VERSIONED)
S3_A2_COMPLETENESS_PASS_AUTHORIZED=false
CURRENT_S3_DAILY_ROWSET_COMPLETENESS_VERIFIED=false
NO_BINDABLE_CATALOG_IN_REPOSITORY=true
EVALUATION_INSTANCE_REGISTRY_AVAILABLE=false
...
~~~text
EVIDENCE_JSON_SHA256=824f26ae9511da99b2013954ee61c51fe97f763579c3e4c24af2435fe397d232
~~~
