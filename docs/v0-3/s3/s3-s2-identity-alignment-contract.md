...
## 11. S2 identity alignment implementation authorization pointer
...
## 12. S2 identity alignment implementation authorization amendment R1 pointer
...
pointer does not rewrite contract freeze rules in §§1–10.

## 13. S2 identity alignment adapter R1 pointer
...
## 15. Accepted S2 identity alignment evidence producer implementation authorization pointer
...
## 16. Accepted S2 identity alignment evidence producer R1 pointer
...
## 17. Incumbent forecast artifact content producer contract pointer
...
## 18. Incumbent forecast artifact content producer implementation authorization pointer
...
## 19. Incumbent forecast artifact content producer R1 pointer
