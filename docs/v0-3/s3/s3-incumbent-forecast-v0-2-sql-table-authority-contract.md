...
## 40. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin implementation authorization pointer
...
## 41. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin R1 pointer
...
## 42. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set implementation authorization pointer
...
## 43. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set R1 pointer
...
## 44. Incumbent forecast artifact repository-presence contract pointer
...
## 45. Incumbent forecast artifact repository-presence implementation authorization pointer
...
## 46. Incumbent forecast artifact repository-presence R1 pointer
