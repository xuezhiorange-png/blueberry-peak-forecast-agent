...
~~~text
CONTRACT_ID=V0_3_S3_A2_ACCEPTED_S2_TRAIN_VAL_SOURCE_002_ROW_LEVEL_READ_LIVE_ASYNC_SESSION_CONTRACT
...
LIVE_ASYNC_CONNECTION_R1_WORKPAPER_GIT_BLOB_SHA=10c66ae225d6162aa24d8281fb24a927832b19da
LIVE_ASYNC_CONNECTION_R1_EVIDENCE_GIT_BLOB_SHA=59179ad97cfd345fdc8eef71e6b748c47176b233
...
DOES_NOT_REWRITE_LIVE_ASYNC_CONNECTION_FREEZE=true
...
LIVE_ASYNC_CONNECTION_MODULE=backend/app/s3_daily_rowset/accepted_s2_train_val_source_002_row_level_read_live_async_connection.py
...
ASYNC_SESSION_IS_NOT_QUERYABLE_SESSION=true
ASYNC_SESSION_IS_NOT_CONTENT_BYTES_OBTAINED=true
ASYNC_SESSION_IS_NOT_SOURCE_002_ROW_LEVEL_READ=true
THIS_FAMILY_DOES_NOT_AUTHORIZE_A_DOCS_ONLY_IMPLEMENTED_FLIP_AS_SUBSTITUTE_FOR_AN_ASYNC_SESSION_FROM_THE_ALREADY_CONFIGURED_LIVE_ASYNC_SESSION_MAKER=true
...
8. User authorized a **new family** to freeze WHAT/HOW for that async session.
...
THIS_FAMILY_IS_NOT_THE_LIVE_OBTAIN_SLICE_FOR_TRAIN_VAL_CONTENT_BYTES=true
THIS_FAMILY_IS_NOT_THE_BOUND_LIVE_SESSION_QUERYABLE_SLICE=true
THIS_FAMILY_AUTHORIZES_FUTURE_ASYNC_SESSION_FROM_THE_ALREADY_CONFIGURED_LIVE_ASYNC_SESSION_MAKER=true
THIS_PR_DOES_NOT_OBTAIN_AN_ASYNC_SESSION_FROM_THE_ALREADY_CONFIGURED_LIVE_ASYNC_SESSION_MAKER=true
LANDED_ASYNC_SESSION_MAKER_MODULE=backend/app/db/session.py
LANDED_ASYNC_SESSION_MAKER_MODULE_GIT_BLOB_SHA=49845a077d252af2a7a246fa25616d7595535037
LANDED_ASYNC_SESSION_MAKER=AsyncSessionMaker
...
FAIL_CLOSED_SESSION_UNREADABLE_IS_NOT_SOURCE_002_ROW_LEVEL_READ=true
FAIL_CLOSED_SESSION_NOT_SYNCHRONOUSLY_QUERYABLE_IS_NOT_SOURCE_002_ROW_LEVEL_READ=true
LIVE_ASYNC_SESSION_IS_NOT_IDENTITY_SET_MEMBER_ENUMERATION=true
LIVE_ASYNC_SESSION_IS_NOT_FORECAST_ARTIFACT=true
LIVE_ASYNC_SESSION_DOES_NOT_REWRITE_POPULATED_ORIGIN_FAIL_CLOSED=true
...
FORBIDDEN_CALL_CREATE_ASYNC_ENGINE=true
FORBIDDEN_CALL_ASYNC_SESSIONMAKER=true
FORBIDDEN_REREAD_XLS=true
FORBIDDEN_RAW_SOURCE_002_PRIMARY_READ=true
~~~

Future implementation of **this** family may obtain an asynchronous session
from the already-configured live AsyncSessionMaker. It must not invent a DSN, must not
call create_async_engine or async_sessionmaker, must not claim the Session itself is queryable, must not
...
| Obtain async session from already-configured live AsyncSessionMaker | forbidden |
...
## 13. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-session contract live-authority pointer
...
## 14. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-session authorization pointer
...
## 15. S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-session R1 pointer
