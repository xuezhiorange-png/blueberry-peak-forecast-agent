...
## 33. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin contract pointer
...
## 34. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin implementation authorization pointer
...
## 35. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin R1 pointer
...
## 36. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set implementation authorization pointer
...
## 37. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set R1 pointer
...
## 38. Incumbent forecast artifact repository-presence contract pointer
...
## 39. Incumbent forecast artifact repository-presence implementation authorization pointer
...
## 40. Incumbent forecast artifact repository-presence R1 pointer
