...
## 13. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source acquisition implementation authorization pointer
...
## 14. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source acquisition R1 pointer
...
## 15. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin contract pointer
...
## 16. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin implementation authorization pointer
...
## 17. Incumbent forecast V0.2 replay-identity grain identity-set candidate-source populated-origin R1 pointer
...
## 18. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set implementation authorization pointer
...
## 19. Incumbent forecast V0.2 replay-identity grain identity-set reviewed-set R1 pointer
...
## 20. Incumbent forecast artifact repository-presence contract pointer
...
## 21. Incumbent forecast artifact repository-presence implementation authorization pointer
...
## 22. Incumbent forecast artifact repository-presence R1 pointer
