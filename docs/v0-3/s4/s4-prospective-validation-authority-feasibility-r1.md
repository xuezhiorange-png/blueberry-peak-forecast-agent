...
The implementation commit is `dc1a532811d921a6bb83c7b6cee81cee277e0d0f`.
...
After Phase A validation, one and only one live scan was attempted with the
frozen repository identity. It was not replaced by a fixture or a local
synthetic database.
