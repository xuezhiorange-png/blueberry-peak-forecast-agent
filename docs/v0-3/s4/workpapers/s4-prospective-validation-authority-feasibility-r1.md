...
INITIAL_IMPLEMENTATION_COMMIT=dc1a532811d921a6bb83c7b6cee81cee277e0d0f
...
Exactly one corrected read-only scan was attempted after the corrected scanner
freeze and exact-head CI passed:
