...
#### S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-obtain contract live-authority pointer
...
#### S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-obtain authorization pointer
...
#### S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-obtain R1 pointer
...
#### S3-A2 accepted S2 TRAIN/VAL SOURCE_002 row-level-read live-async-session-query contract live-authority pointer
