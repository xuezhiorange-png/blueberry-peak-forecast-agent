...
| `daily_mape` | `v0.3-metric-contract-v1` | `docs/forecast-quality/s3-quality-metrics-contract.md` | `§6.1` | accepted P50 mask and positive-actual denominator policy | `NOT_ISSUED` | `NOT_ISSUED` | `NOT_ISSUED_CURRENT_STATE` |
