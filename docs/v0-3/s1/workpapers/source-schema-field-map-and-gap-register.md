...
| `DECIMAL_PLACES` | `BUSINESS_CONFIRMED=3` | Formal decimal evidence if required. |
| `INTEGER_ROUNDING` | `BUSINESS_CONFIRMED=false` | Formal rounding evidence if required. |
| `DECIMAL_PRECISION_AND_ROUNDING` | `BUSINESS_CONFIRMED_3_DECIMAL_PLACES_NO_INTEGER_ROUNDING` | Formal source-attestation binding. |
