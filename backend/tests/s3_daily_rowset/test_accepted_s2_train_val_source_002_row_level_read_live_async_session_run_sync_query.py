...
LIVE_ASYNC_SESSION_TEST_PY_BLOB = "99ec03d337f7fd32f0cdf0934d8feaf66d2595d2"
LIVE_ASYNC_OBTAIN_TEST_PY_BLOB = "f9af249bb0f67f31177077adb22519d6a3e7e888"
LIVE_ASYNC_SESSION_QUERY_TEST_PY_BLOB = "168bb88ee3003008be9fbb5621bdbf94a1bfc25c"
LIVE_ASYNC_SESSION_BIND_TEST_PY_BLOB = "42f777f136468db839f058fd2247849ef608a3aa"
LIVE_ASYNC_SESSION_CONNECTION_TEST_PY_BLOB = "5fdd568e3e1c43941e31a81d53ef7e8ac80f97f7"
LIVE_ASYNC_SESSION_CONNECTION_QUERY_TEST_PY_BLOB = "cdc4aaaa26c6a150316c6277b2f8476b13ef51ed"
LIVE_ASYNC_SESSION_CONNECTION_OBTAIN_TEST_PY_BLOB = "95061ab70bd85d8c1cb5d710e83d2c41a158050e"
LIVE_ASYNC_SESSION_BIND_QUERY_TEST_PY_BLOB = "9de2eb682f8a1170694e7fe84e0c0f50200f824a"
LIVE_ASYNC_SESSION_BIND_OBTAIN_TEST_PY_BLOB = "5f6242569933d117765ff81db20066ad25b3628a"
...
def test_parent_reader_live_session_obtain_and_async_siblings_blobs_unchanged() -> None:
    ...
    live_async_session_bind_query_blob = subprocess.check_output(
        ["git", "hash-object", str(LIVE_ASYNC_SESSION_BIND_QUERY_MODULE)],
        text=True,
    ).strip()
    live_async_session_bind_obtain_blob = subprocess.check_output(
        ["git", "hash-object", str(LIVE_ASYNC_SESSION_BIND_OBTAIN_MODULE)],
        text=True,
    ).strip()
    ...
    live_async_session_bind_query_tests = subprocess.check_output(
        [
            "git",
            "hash-object",
            "backend/tests/s3_daily_rowset/"
            "test_accepted_s2_train_val_source_002_row_level_read_live_async_session_bind_query.py",
        ],
        text=True,
    ).strip()
    live_async_session_bind_obtain_tests = subprocess.check_output(
        [
            "git",
            "hash-object",
            "backend/tests/s3_daily_rowset/"
            "test_accepted_s2_train_val_source_002_row_level_read_live_async_session_bind_obtain.py",
        ],
        text=True,
    ).strip()
    ...
    assert live_async_session_bind_query_blob == LIVE_ASYNC_SESSION_BIND_QUERY_PY_BLOB
    assert live_async_session_bind_obtain_blob == LIVE_ASYNC_SESSION_BIND_OBTAIN_PY_BLOB
    ...
    assert live_async_session_bind_query_tests == LIVE_ASYNC_SESSION_BIND_QUERY_TEST_PY_BLOB
    assert live_async_session_bind_obtain_tests == LIVE_ASYNC_SESSION_BIND_OBTAIN_TEST_PY_BLOB
