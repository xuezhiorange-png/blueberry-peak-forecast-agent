...
from backend.app.agent.schemas import ParameterOverride, YieldPerMuOverrideValue


TOOL_MODELS = [
    ResolveLocationInput, ResolveLocationOutput,
    InferParametersInput, InferParametersOutput,
    ForecastDailyCurveInput, ForecastDailyCurveOutput,
    ForecastPeakInput, ForecastPeakOutput,
    SimulateScenarioInput, SimulateScenarioOutput,
    RunBacktestInput, RunBacktestOutput,
    ExplainForecastInput, ExplainForecastOutput,
