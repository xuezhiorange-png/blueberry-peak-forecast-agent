...
class ResidualModelPredictionRow(Base):
    ...
    forecast_horizon_days: Mapped[int] = mapped_column(_BIGINT_VARIANT, nullable=False)
    structural_p50_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    structural_p80_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    structural_p90_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    raw_residual_p50_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    raw_residual_p80_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    raw_residual_p90_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_raw_p50_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_raw_p80_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_raw_p90_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_p50_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_p80_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
    corrected_p90_kg: Mapped[Decimal] = mapped_column(Numeric(18, 3), nullable=False)
