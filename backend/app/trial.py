...
class TrialApiErrorCode(StrEnum):
    AREA_FORECAST_AUTHORITY_UNAVAILABLE = "AREA_FORECAST_AUTHORITY_UNAVAILABLE"
    AREA_FORECAST_UNSUPPORTED_FARM_HISTORY = "AREA_FORECAST_UNSUPPORTED_FARM_HISTORY"
    AREA_FORECAST_REQUEST_INVALID = "AREA_FORECAST_REQUEST_INVALID"
