"""Obtain accepted S2 TRAIN/VALIDATION content_bytes through live AsyncConnection.
...
AsyncConnection from ``await session.connection()`` are not SOURCE_002_ROW_LEVEL_READ and
are not official-hash attestation.
"""
...
class LiveAsyncSessionConnectionObtainReasonCode(StrEnum):
    OBTAINED = "OBTAINED"
    ...
    FAIL_CLOSED_ASYNC_SESSION_CONNECTION_UNREADABLE = (
        "FAIL_CLOSED_ASYNC_SESSION_CONNECTION_UNREADABLE"
    )


_SESSION_CONNECTION_OBTAIN_REASON = LiveAsyncSessionConnectionObtainReasonCode
_NOT_OBTAINED_FROM_SESSION_MAKER = (
    _SESSION_CONNECTION_OBTAIN_REASON.FAIL_CLOSED_ASYNC_SESSION_NOT_OBTAINED_FROM_SESSION_MAKER
)
# fmt: off
_NOT_OBTAINED_FROM_SESSION_CONNECTION = (
    _SESSION_CONNECTION_OBTAIN_REASON.FAIL_CLOSED_ASYNC_CONNECTION_NOT_OBTAINED_FROM_SESSION_CONNECTION
)
# fmt: on
_UNREADABLE = _SESSION_CONNECTION_OBTAIN_REASON.FAIL_CLOSED_ASYNC_SESSION_CONNECTION_UNREADABLE


class AcceptedS2TrainValLiveAsyncSessionConnectionObtainEnvelope(BaseModel):
    ...
    reason_code: LiveAsyncSessionConnectionObtainReasonCode
...
def obtain_accepted_s2_train_val_content_bytes_from_the_already_obtained_live_async_session_connection(  # noqa: E501
    ...
    try:
        ...
        return _fail(LiveAsyncSessionConnectionObtainReasonCode.FAIL_CLOSED_NO_ASYNC_SESSION_MAKER)
...
def _envelope(
    *,
    obtained: bool,
    reason: LiveAsyncSessionConnectionObtainReasonCode,
    test_remains_sealed: bool = True,
    dataset_id: str | None = None,
    dataset_version: str | None = None,
    materialized_dataset_identity_sha256: str | None = None,
    ...
    return AcceptedS2TrainValLiveAsyncSessionConnectionObtainEnvelope(
        obtained=obtained,
...
async def _obtain_from_async_connection(
    ...
    try:
        ...
        return _envelope(
            obtained=True,
            reason=LiveAsyncSessionConnectionObtainReasonCode.OBTAINED,
            dataset_id=accepted["dataset_id"],
            dataset_version=accepted["dataset_version"],
