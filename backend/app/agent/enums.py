...
class BlockerCode(str, Enum):  # noqa: UP042 — kept as str+Enum for explicit string identity
    ...
    SCENARIO_OVERRIDE_EXECUTION_NOT_AVAILABLE = "SCENARIO_OVERRIDE_EXECUTION_NOT_AVAILABLE"
    NO_PERSISTED_PRIOR_SOURCE = "NO_PERSISTED_PRIOR_SOURCE"
    LOCATION_SOURCE_CAPABILITY_MISSING = "LOCATION_SOURCE_CAPABILITY_MISSING"
    INFERENCE_CONFIG_MISSING = "INFERENCE_CONFIG_MISSING"
    INFERENCE_CONFIG_HASH_MALFORMED = "INFERENCE_CONFIG_HASH_MALFORMED"
    TASK9_PER_VARIETY_GRAIN_MISSING = "TASK9_PER_VARIETY_GRAIN_MISSING"
    AUTHORITY_HASH_MALFORMED = "AUTHORITY_HASH_MALFORMED"
    AUTHORITY_DATETIME_MALFORMED = "AUTHORITY_DATETIME_MALFORMED"
    AUTHORITY_IDENTITY_MALFORMED = "AUTHORITY_IDENTITY_MALFORMED"
    AUTHORITY_ARTIFACT_MISSING = "AUTHORITY_ARTIFACT_MISSING"
    AUTHORITY_POLICY_VERSION_MISSING = "AUTHORITY_POLICY_VERSION_MISSING"
    AUTHORITY_AS_OF_MISSING = "AUTHORITY_AS_OF_MISSING"
    AUTHORITY_LINEAGE_MISMATCH = "AUTHORITY_LINEAGE_MISMATCH"
    UPSTREAM_READ_FAILURE = "UPSTREAM_READ_FAILURE"
    SPRING_FESTIVAL_CALENDAR_POLICY_MISSING = "SPRING_FESTIVAL_CALENDAR_POLICY_MISSING"
    ...
    EXPLANATION_POLICY_MISSING = "EXPLANATION_POLICY_MISSING"
    EXPLANATION_TEMPLATE_MISSING = "EXPLANATION_TEMPLATE_MISSING"
    RECOMMENDATION_POLICY_MISSING = "RECOMMENDATION_POLICY_MISSING"
    RECOMMENDATION_RULE_MISSING = "RECOMMENDATION_RULE_MISSING"
    RECOMMENDATION_THRESHOLD_MISSING = "RECOMMENDATION_THRESHOLD_MISSING"
    ...
    EVIDENCE_FIELD_PATH_INVALID = "EVIDENCE_FIELD_PATH_INVALID"
...
RecommendationStatus = Literal["APPLICABLE", "NOT_APPLICABLE", "BLOCKED"]
...
ConditionResult = Literal["TRUE", "FALSE", "UNKNOWN"]
...
MissingDataImpactCode = Literal[
    ...
    "WEATHER_EVIDENCE_MISSING",
    "PHENOLOGY_EVIDENCE_MISSING",
    "STAFFING_PRODUCTIVITY_SOURCE_MISSING",
    "PROCESSOR_CAPACITY_SOURCE_MISSING",
